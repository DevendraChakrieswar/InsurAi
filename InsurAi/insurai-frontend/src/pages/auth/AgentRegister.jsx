      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          ...
          <p className="text-muted mb-0" style={{ fontSize: '0.95rem' }}>
            Create a new agent account for the system
          </p>
        </div>
          ...
          <form onSubmit={handleRegisterAgent}>
            ...
            <div className="mb-4">
              ...
              <div className="form-text text-muted mt-3">
                <div className="row">
                  <div className="col-6">
                    <small className={`d-flex align-items-center mb-1 ${newAgent.password.length >= 8 ? "text-success" : "text-muted"}`} style={{ fontSize: '0.8rem' }}>
                      <i className={`bi ${newAgent.password.length >= 8 ? "bi-check-circle-fill" : "bi-circle"} me-2`}></i>
                      8+ characters
                    </small>
                    <small className={`d-flex align-items-center mb-1 ${/[A-Z]/.test(newAgent.password) ? "text-success" : "text-muted"}`} style={{ fontSize: '0.8rem' }}>
                      <i className={`bi ${/[A-Z]/.test(newAgent.password) ? "bi-check-circle-fill" : "bi-circle"} me-2`}></i>
                      Uppercase letter
                    </small>
                  </div>
                  <div className="col-6">
                    <small className={`d-flex align-items-center mb-1 ${/[0-9]/.test(newAgent.password) ? "text-success" : "text-muted"}`} style={{ fontSize: '0.8rem' }}>
                      <i className={`bi ${/[0-9]/.test(newAgent.password) ? "bi-check-circle-fill" : "bi-circle"} me-2`}></i>
                      Number
                    </small>
                    <small className={`d-flex align-items-center mb-1 ${/[^A-Za-z0-9]/.test(newAgent.password) ? "text-success" : "text-muted"}`} style={{ fontSize: '0.8rem' }}>
